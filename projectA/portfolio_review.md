...
:---: | :--------------------------------------------------------------------------------------- | :----------:
`1` | Dr. Love has verified that you successfully submitted a working video file, **and** has evaluated your `qmd` and `Rds` files, **and** all of your HTML file *other than* Section 10. | DONE for all 35 projects.
