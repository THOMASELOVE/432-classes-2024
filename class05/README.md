...
- Frank E. Harrell and Chris Slaughter [Biostatistics for Biomedical Research Notes](https://hbiostat.org/bbr/) - also see the YouTube course above.
- Frank E. Harrell [Regression Modeling Strategies](https://github.com/THOMASELOVE/432-sources/blob/main/pdf/Harrell_Regression_Modeling_Strategies_2015_2e_protected.pdf), 2nd Edition, 2015. (download PDF and then input password to see it)
