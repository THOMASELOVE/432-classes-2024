...
9. In Section 5 (the Codebook) I did something useful in the Project Demonstration (available on our Shared Drive) that I didn't include in the instructions or template, but I should have. There, I propose that you start the codebook with the following five elements, which I suggest you should all do in your next revision (and in the Portfolio.)
...
10. Spelling, grammar and proper use of complete English sentences all count. Don't neglect these fundamentals.
11. I will post individual comments to you via Canvas when I'm sufficiently satisfied, and via email if I'm not and am requesting a resubmission.
